...
internal data object ObjectModelResourcePropertyNames : SealedGeneratorTarget(
    ...
    GeneratorTargetOutputGenerator.MustacheTemplate("object_model_property_names.kt.mustache"),
)