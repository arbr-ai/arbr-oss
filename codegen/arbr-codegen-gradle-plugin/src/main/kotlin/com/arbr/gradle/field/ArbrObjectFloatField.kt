...
abstract class ArbrObjectFloatField @Inject constructor(
    name: String,
    ...
    init {
        type.set(ArbrPrimitiveValueType.FLOAT)
    }

    companion object {
        const val DEFAULT_CODEC_CLASS = "com.arbr.platform.object_graph.encoder.ObjectFloatFieldCodec"
    }
}