...
abstract class ArbrObjectBooleanField @Inject constructor(
    name: String,
    ...
    init {
        type.set(ArbrPrimitiveValueType.BOOLEAN)
    }

    companion object {
        const val DEFAULT_CODEC_CLASS = "com.arbr.platform.object_graph.encoder.ObjectBooleanFieldCodec"
    }
}