...
//    implementation(project(":arbr-platform"))
    ...
    compileOnly("org.postgresql:r2dbc-postgresql:1.0.4.RELEASE")
    compileOnly("io.r2dbc:r2dbc-pool:1.0.0.RELEASE")
...
//    implementation("io.github.resilience4j:resilience4j-reactor:2.0.2")
    ...
    // AWS SDK + S3
    compileOnly("software.amazon.awssdk:s3:2.17.184")
    compileOnly("software.amazon.awssdk:core:2.17.184")
...
publishing {
    ...
    publications {
        register<MavenPublication>("gpr") {
            artifactId = "arbr-platform-spring-autoconfigure"
