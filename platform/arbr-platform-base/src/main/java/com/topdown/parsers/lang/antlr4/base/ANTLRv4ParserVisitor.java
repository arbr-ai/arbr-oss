...
public interface ANTLRv4ParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#action_}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAction_(ANTLRv4Parser.Action_Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#predicateOptions}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPredicateOptions(ANTLRv4Parser.PredicateOptionsContext ctx);
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#predicateOption}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPredicateOption(ANTLRv4Parser.PredicateOptionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ANTLRv4Parser#terminalDef}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTerminalDef(ANTLRv4Parser.TerminalDefContext ctx);
	/**
