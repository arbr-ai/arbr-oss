...
public interface JavaScriptParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitHtmlElementExpression(JavaScriptParser.HtmlElementExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitHtmlElements(JavaScriptParser.HtmlElementsContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#htmlElement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlElement(JavaScriptParser.HtmlElementContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#htmlTagClose}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlTagClose(JavaScriptParser.HtmlTagCloseContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#htmlContent}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlContent(JavaScriptParser.HtmlContentContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#htmlQualifiedIdentifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlQualifiedIdentifier(JavaScriptParser.HtmlQualifiedIdentifierContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#htmlTagName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlTagName(JavaScriptParser.HtmlTagNameContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitHtmlChardata(JavaScriptParser.HtmlChardataContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#htmlAttributeValue}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlAttributeValue(JavaScriptParser.HtmlAttributeValueContext ctx);
	/**
	 * Visit a parse tree produced by {@link JavaScriptParser#htmlExpressionSequence}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHtmlExpressionSequence(JavaScriptParser.HtmlExpressionSequenceContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitObjectExpressionSequence(JavaScriptParser.ObjectExpressionSequenceContext ctx);
	/**
