...
open class VectorNorm : AbstractRoutine<Double>("vector_norm", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {
        ...
        /**
         * The parameter <code>public.vector_norm._1</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorNorm {
        setField(_1, field)
        return this
    }
}
