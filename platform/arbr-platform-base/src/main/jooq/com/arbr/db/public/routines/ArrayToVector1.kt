...
open class ArrayToVector1 : AbstractRoutine<Vector1536>("array_to_vector", com.arbr.db.`public`.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"vector\""), Vector1536Binding()) {
    companion object {
         ...
         */
        val _1: Parameter<Array<Int?>?> = Internal.createParameter("_1", SQLDataType.INTEGER.array(), false, true)
     ...
     */
    fun set__1(value: Array<Int?>?): Unit = setValue(_1, value)

    /**
     * Set the <code>_1</code> parameter to the function to be used with a
     * {@link org.jooq.Select} statement
     */
    fun set__1(field: Field<Array<Int?>?>): ArrayToVector1 {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Int?>): ArrayToVector1 {
        setField(_2, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__3(field: Field<Boolean?>): ArrayToVector1 {
        setField(_3, field)
        return this
    }
}
