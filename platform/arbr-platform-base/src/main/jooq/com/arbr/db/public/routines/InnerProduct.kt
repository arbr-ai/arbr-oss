...
open class InnerProduct : AbstractRoutine<Double>("inner_product", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {
        ...
        /**
         * The parameter <code>public.inner_product._1</code>.
         */
        ...
        /**
         * The parameter <code>public.inner_product._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): InnerProduct {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): InnerProduct {
        setField(_2, field)
        return this
    }
}
