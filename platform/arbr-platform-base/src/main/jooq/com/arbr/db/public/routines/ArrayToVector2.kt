...
open class ArrayToVector2 : AbstractRoutine<Vector1536>("array_to_vector", com.arbr.db.`public`.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"vector\""), Vector1536Binding()) {
    companion object {
     ...
     */
    fun set__1(field: Field<Array<Float?>?>): ArrayToVector2 {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Int?>): ArrayToVector2 {
        setField(_2, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__3(field: Field<Boolean?>): ArrayToVector2 {
        setField(_3, field)
        return this
    }
}
