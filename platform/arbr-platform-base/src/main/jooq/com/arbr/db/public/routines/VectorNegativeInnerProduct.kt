...
open class VectorNegativeInnerProduct : AbstractRoutine<Double>("vector_negative_inner_product", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {
        ...
        /**
         * The parameter <code>public.vector_negative_inner_product._1</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_negative_inner_product._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorNegativeInnerProduct {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): VectorNegativeInnerProduct {
        setField(_2, field)
        return this
    }
}
