...
open class VectorNe : AbstractRoutine<Boolean>("vector_ne", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {
        ...
        /**
         * The parameter <code>public.vector_ne._1</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_ne._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorNe {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): VectorNe {
        setField(_2, field)
        return this
    }
}
