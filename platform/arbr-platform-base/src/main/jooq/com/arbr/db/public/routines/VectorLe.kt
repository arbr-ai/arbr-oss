...
open class VectorLe : AbstractRoutine<Boolean>("vector_le", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {
        ...
        /**
         * The parameter <code>public.vector_le._1</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_le._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorLe {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): VectorLe {
        setField(_2, field)
        return this
    }
}
