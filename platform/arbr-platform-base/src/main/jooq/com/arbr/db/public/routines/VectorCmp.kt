...
open class VectorCmp : AbstractRoutine<Int>("vector_cmp", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.INTEGER) {
    companion object {
        ...
        /**
         * The parameter <code>public.vector_cmp._1</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_cmp._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorCmp {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): VectorCmp {
        setField(_2, field)
        return this
    }
}
