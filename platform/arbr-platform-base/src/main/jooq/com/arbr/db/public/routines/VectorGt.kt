...
open class VectorGt : AbstractRoutine<Boolean>("vector_gt", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {
        ...
        /**
         * The parameter <code>public.vector_gt._1</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_gt._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorGt {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): VectorGt {
        setField(_2, field)
        return this
    }
}
