...
open class L2Distance : AbstractRoutine<Double>("l2_distance", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {
        ...
        /**
         * The parameter <code>public.l2_distance._1</code>.
         */
        ...
        /**
         * The parameter <code>public.l2_distance._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): L2Distance {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): L2Distance {
        setField(_2, field)
        return this
    }
}
