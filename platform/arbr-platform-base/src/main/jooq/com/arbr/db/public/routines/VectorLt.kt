...
open class VectorLt : AbstractRoutine<Boolean>("vector_lt", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.BOOLEAN) {
    companion object {
        ...
        /**
         * The parameter <code>public.vector_lt._1</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_lt._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorLt {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): VectorLt {
        setField(_2, field)
        return this
    }
}
