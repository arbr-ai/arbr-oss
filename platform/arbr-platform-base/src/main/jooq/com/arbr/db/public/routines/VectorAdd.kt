...
open class VectorAdd : AbstractRoutine<Vector1536>("vector_add", com.arbr.db.`public`.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"vector\""), Vector1536Binding()) {
    companion object {

        /**
         * The parameter <code>public.vector_add.RETURN_VALUE</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_add._1</code>.
         */
        ...
        /**
         * The parameter <code>public.vector_add._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): VectorAdd {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): VectorAdd {
        setField(_2, field)
        return this
    }
}
