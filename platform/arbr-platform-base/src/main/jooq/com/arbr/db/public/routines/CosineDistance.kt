...
open class CosineDistance : AbstractRoutine<Double>("cosine_distance", com.arbr.db.`public`.Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {
        ...
        /**
         * The parameter <code>public.cosine_distance._1</code>.
         */
        ...
        /**
         * The parameter <code>public.cosine_distance._2</code>.
         */
     ...
     */
    fun set__1(field: Field<Vector1536?>): CosineDistance {
        setField(_1, field)
        return this
    }
     ...
     * {@link org.jooq.Select} statement
     */
    fun set__2(field: Field<Vector1536?>): CosineDistance {
        setField(_2, field)
        return this
    }
}
