...
open class ArrayToVector4 : AbstractRoutine<Vector1536>("array_to_vector", com.arbr.db.`public`.Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"vector\""), Vector1536Binding()) {
    companion object {
     ...
     */
    fun set__1(value: Array<BigDecimal?>?): Unit = setValue(_1, value)
