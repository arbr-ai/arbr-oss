...
class NestedObjectListType7<V1, V2, V3, V4, V5, V6, V7, QT1 : Shape, QF1 : Shape, QT2 : Shape, QF2 : Shape, QT3 : Shape, QF3 : Shape, QT4 : Shape, QF4 : Shape, QT5 : Shape, QF5 : Shape, QT6 : Shape, QF6 : Shape, QT7 : Shape, QF7 : Shape, S1 : ObjectModel.ObjectValue<V1, QT1, QF1, S1>, S2 : ObjectModel.ObjectValue<V2, QT2, QF2, S2>, S3 : ObjectModel.ObjectValue<V3, QT3, QF3, S3>, S4 : ObjectModel.ObjectValue<V4, QT4, QF4, S4>, S5 : ObjectModel.ObjectValue<V5, QT5, QF5, S5>, S6 : ObjectModel.ObjectValue<V6, QT6, QF6, S6>, S7 : ObjectModel.ObjectValue<V7, QT7, QF7, S7>>(
    key: String,
    description: String,
    ...
    ) : NestedObjectListType<List<NestedObjectListType7.InnerValue<V1, V2, V3, V4, V5, V6, V7>>,
        Shape.Product<Dim.VariableC, Shape.Sum<QT1, Shape.Sum<QT2, Shape.Sum<QT3, Shape.Sum<QT4, Shape.Sum<QT5, Shape.Sum<QT6, QT7>>>>>>>,
        Shape.Product<Dim.VariableC, Shape.Sum<QF1, Shape.Sum<QF2, Shape.Sum<QF3, Shape.Sum<QF4, Shape.Sum<QF5, Shape.Sum<QF6, QF7>>>>>>>,
        NestedObjectListType7.Value<V1, V2, V3, V4, V5, V6, V7, QT1, QF1, QT2, QF2, QT3, QF3, QT4, QF4, QT5, QF5, QT6, QF6, QT7, QF7, S1, S2, S3, S4, S5, S6, S7>> {
    override val typeName: String
        get() = "[{${innerType1.typeName},${innerType2.typeName},${innerType3.typeName},${innerType4.typeName},${innerType5.typeName},${innerType6.typeName},${innerType7.typeName},}]"
        ...
        SumTensor.of(
            ...
            SumTensor.of(
                ...
                SumTensor.of(
                    ...
                    SumTensor.of(
                        innerType4.tensor,
                        SumTensor.of(innerType5.tensor, SumTensor.of(innerType6.tensor, innerType7.tensor))
                    )
                )
            )
        )
    ...
    data class InnerValue<V1, V2, V3, V4, V5, V6, V7>(
        private val objectType: NestedObjectListType7<V1, V2, V3, V4, V5, V6, V7, *, *, *, *, *, *, *, *, *, *, *, *, *, *, *, *, *, *, *, *, *>,
        val t1: V1,
        val t2: V2,
        val t3: V3,
        val t4: V4,
    ...
    data class Value<V1, V2, V3, V4, V5, V6, V7, QT1 : Shape, QF1 : Shape, QT2 : Shape, QF2 : Shape, QT3 : Shape, QF3 : Shape, QT4 : Shape, QF4 : Shape, QT5 : Shape, QF5 : Shape, QT6 : Shape, QF6 : Shape, QT7 : Shape, QF7 : Shape, S1 : ObjectModel.ObjectValue<V1, QT1, QF1, S1>, S2 : ObjectModel.ObjectValue<V2, QT2, QF2, S2>, S3 : ObjectModel.ObjectValue<V3, QT3, QF3, S3>, S4 : ObjectModel.ObjectValue<V4, QT4, QF4, S4>, S5 : ObjectModel.ObjectValue<V5, QT5, QF5, S5>, S6 : ObjectModel.ObjectValue<V6, QT6, QF6, S6>, S7 : ObjectModel.ObjectValue<V7, QT7, QF7, S7>>(
        override val objectType: NestedObjectListType7<V1, V2, V3, V4, V5, V6, V7, QT1, QF1, QT2, QF2, QT3, QF3, QT4, QF4, QT5, QF5, QT6, QF6, QT7, QF7, S1, S2, S3, S4, S5, S6, S7>,
        override val kind: SourcedValueKind,
        override val value: List<InnerValue<V1, V2, V3, V4, V5, V6, V7>>,
        override val generatorInfo: SourcedValueGeneratorInfo,
    ) : ObjectModel.ObjectValueImpl<List<InnerValue<V1, V2, V3, V4, V5, V6, V7>>,
            Shape.Product<Dim.VariableC, Shape.Sum<QT1, Shape.Sum<QT2, Shape.Sum<QT3, Shape.Sum<QT4, Shape.Sum<QT5, Shape.Sum<QT6, QT7>>>>>>>,
            Shape.Product<Dim.VariableC, Shape.Sum<QF1, Shape.Sum<QF2, Shape.Sum<QF3, Shape.Sum<QF4, Shape.Sum<QF5, Shape.Sum<QF6, QF7>>>>>>>,
            Value<V1, V2, V3, V4, V5, V6, V7, QT1, QF1, QT2, QF2, QT3, QF3, QT4, QF4, QT5, QF5, QT6, QF6, QT7, QF7, S1, S2, S3, S4, S5, S6, S7>>(
        kind,
        value,
        objectType,
        generatorInfo,
        ...
        val containers: List<SourcedStruct7<S1, S2, S3, S4, S5, S6, S7>> by lazy {
            value.map {
                SourcedStruct7(
    ...
    override fun parseInnerValueFromObject(value: Any?): List<InnerValue<V1, V2, V3, V4, V5, V6, V7>> {
    ...
    fun initializeMerged(
        containers: List<SourcedStruct7<S1, S2, S3, S4, S5, S6, S7>>,
    ): Value<V1, V2, V3, V4, V5, V6, V7, QT1, QF1, QT2, QF2, QT3, QF3, QT4, QF4, QT5, QF5, QT6, QF6, QT7, QF7, S1, S2, S3, S4, S5, S6, S7> =
        initialize(
            containers.flatMap {
                listOf(
    ...
    override fun initialize(
        ...
        value: List<InnerValue<V1, V2, V3, V4, V5, V6, V7>>,
